...
while ($true) {
    ...
    if ($Choser -eq 1) {
        ...
        elseif ($ChoserPF -eq 2) {
            ...
            $urlPB = "https://github.com/spokwn/prefetch-parser/releases/download/v1.5.2/PrefetchParser.exe"
    ...
    elseif ($Choser -eq 2) {
        ...
        elseif ($Choser2 -eq 2) {
            ...
            $url3 = "https://github.com/spokwn/pcasvc-executed/releases/download/v0.8.3/PcaSvcExecuted.exe"
...
Logo 
        ...
        elseif ($Choser3 -eq 2) {
            ...
            $url9 = "https://github.com/spokwn/BAM-parser/releases/download/v1.2.3/BAMParser.exe"
    ...
    elseif ($Choser -eq 9){
        cls
                ...
                elseif ($Choser5 -eq 2) {
                    ...
                    $url10 = "https://github.com/spokwn/PathsParser/releases/download/v1.0.4/PathsParser.exe"
    ...
    do {
        ...
        elseif ($ChoserLU -eq 3) {
            ...
            elseif ($Choser4 -eq 4) {
                Write-Host "Baixando journaltrace by ponei"  
                    $url12 = "https://github.com/ponei/JournalTrace/releases/download/1.0/JournalTrace.exe"
                    $destinationFile12 = "$OutfilePath\JournalTrace.exe"
                    Invoke-WebRequest -Uri $url12 -OutFile $destinationFile12
                    Write-Host "Download completo!" -ForegroundColor Green
                    Start-Sleep -Seconds 1
                    cls
